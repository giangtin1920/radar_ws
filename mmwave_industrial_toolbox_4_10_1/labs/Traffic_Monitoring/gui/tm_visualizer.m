...
if(SETUP_VIA_GUI)
    ...
    cfgFile.path = 'C:/ti/mmwave_industrial_toolbox_4_7_0/labs/long_range_people_detection/68xx_long_range_people_det/chirp_configs/';
    cfgFile.name = 'people_detection_and_tracking_100m_2D_advanced.cfg';
    logFile.path = '';
...
hFig = figure('Name', 'Traffic Monitoring Visualizer V2.0.1','Color','white','CloseRequestFcn',@plotfig_closereq);
